...
export default function WelcomeScreen({ onSuggestion }: Props) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full px-6 py-8 gap-6 overflow-y-auto">
      {/* Logo & Title */}
      <motion.div 
      ...
      >
        <div className="w-16 h-16 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 relative">
          <Image
            src="/logo.png"
            alt="Astra AI Logo"
            fill
      ...
      {/* Trending Topics Section (Live Suggestions) */}
      <motion.div
